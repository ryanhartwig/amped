...
exercises.post('/new', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `, params);
    if (!response.rowCount)
        return res.status(500).json('Could not add exercise');
...
exercises.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!existing.rowCount)
        return res.status(404).json('Could not find exercise with given id');
  ...
  `, [id, ...params]);
    if (!response.rowCount)
        return res.status(500).json('Could not update exercise');
