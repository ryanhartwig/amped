...
set.post('/new', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `, params);
    if (!response.rowCount)
        return res.status(500).send('Could not create set data');
...
set.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `, [id, ...params]);
    if (!response.rowCount)
        return res.status(500).send('Could not update set data');
...
set.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!response.rowCount)
        return res.status(404).send('No set data with provided id exists');
