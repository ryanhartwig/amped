...
app.use(cors({
  credentials: true,
  origin: getEnv('https://ampedpro.netlify.app', 'http://localhost:3000'),
}));
...
app.listen(port, () => {
  console.log('⚡️', getEnv('Server is running at amped.herokuapp.com', `Server is running at localhost:${port}`));
});
