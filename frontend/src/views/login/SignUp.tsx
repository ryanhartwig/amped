  ...
  return (
    <>
      ...
      <div className="SignUp-creds">
        <Input placeholder='username' onBlur={onVerifyUsername} onChange={(e) => setName(e.target.value)}/>
        <Input placeholder='password' type='password' onChange={(e) => setP1(e.target.value)}/>
        <Input placeholder='confirm password' type='password' onChange={(e) => setP2(e.target.value)}/>
      </div>
      <PrimaryButton icon={'logo'} altColor disabled={!allValid} text='Sign up' />
